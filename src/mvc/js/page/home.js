      ...
      server: {
        template: `
          <div class="bbn-flex-width">
            <div :class="['bbn-vmiddle', 'bbn-spadding', 'bbn-white', {
                   'bbn-border-bottom': !!comp.getRef('serversList').currentData[index + 1]
                 }]"
            ...
            <div class="bbn-flex-fill bbn-grid-fields bbn-spadding"
                 style="gap: 0 1rem"
                 @click="select">
            ...
            <div :class="{'bbn-border-bottom': !!comp.getRef('serversList').currentData[index + 1]}">
